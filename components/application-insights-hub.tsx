...
export function ApplicationInsightsHub({
  ...
  return (
    <div style={{ marginBottom: 32, display: 'flex', flexDirection: 'column', gap: 24 }}>
      {/* 1️⃣ STAGE COMMAND CENTER — Unified Decision Block with V5 Upgrades */}
      <div
        style={{
          background: '#FFFFFF',
      ...
      >
        {/* V5 UPGRADE 8️⃣: Momentum Signal */}
        ...
        {/* V5 UPGRADE 1️⃣: Dynamic Stage Label with Time-Awareness */}
        ...
        {/* V5 UPGRADE 2️⃣: Micro-Progress Context */}
        <div
          style={{
            background: '#F8FAFC',
        ...
        {/* V5 UPGRADE 3️⃣: Today's Recommended Move with Reasoning */}
        <div
          style={{
            background: '#F0F9FF',
            border: '2px solid #BFDBFE',
        ...
        {/* V5 UPGRADE 4️⃣: If-No-Response Plan */}
        <div
          style={{
            background: '#FFFBEB',
      ...
      {/* 2️⃣ APPLICATION FIT ANALYSIS — Streamlined with V5 Upgrades */}
      <div
        style={{
          background: '#FFFFFF',
      ...
      >
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          {/* V5 UPGRADE 5️⃣: Benchmarking Percentile */}
      ...
      {/* 3️⃣ SCREENING PREP — Interactive with V5 Upgrades */}
      <div
        style={{
          background: '#FFFFFF',
          border: '1px solid #E5E7EB',
      ...
      >
        ...
        {/* V5 UPGRADE 6️⃣: High-Probability Questions with Interactive Expansion */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {[
            ...
            >
              ...
              {/* V5 UPGRADE 6️⃣: Expandable Sample Answer */}
      ...
      {/* V5 UPGRADE 7️⃣: Temporal Logic for Follow-up Button */}
      <div
        style={{
