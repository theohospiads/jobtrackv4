...
export function ApplicationInsightsHub({
  ...
  const followUpWindowOpen = false // Calculate based on submission date
  const screeningProbability = 'Moderate' // 42% probability

  return (
    <div style={{ marginBottom: 32, display: 'flex', flexDirection: 'column', gap: 20 }}>
      {/* V3 OPTIMIZATION 1️⃣ PRIMARY ACTION BLOCK — Tightened Language */}
      <div
        style={{
      ...
      >
        ...
        >
          {hasActionRequired
            ? 'This is your priority at this stage.'
            : "We'll notify you when action becomes beneficial."}
        </p>
        ...
        {!hasActionRequired && (
          ...
          >
            Light preparation is recommended.
          </p>
        )}
      </div>
      ...
      {/* V3 OPTIMIZATION 2️⃣ Application Strength — Improved Visual Hierarchy */}
      <div
        style={{
          background: '#FFFFFF',
          border: '1px solid #E5E7EB',
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 32, alignItems: 'flex-start', marginBottom: 24 }}>
          {/* Circular Score — Reduced visual dominance */}
          <div
            style={{
              display: 'flex',
        ...
        {/* V3: Recommended Improvement — Visually Elevated for Behavioral Leverage */}
        <div
          style={{
            background: '#FFFBEB',
        ...
        >
          ...
          <p style={{ fontSize: 13, color: '#92400E', margin: '6px 0 0 0' }}>
            This directly addresses your experience gap and increases fit by ~5%
          </p>
        </div>
      ...
      {/* V3 OPTIMIZATION 3️⃣ Smart Preparation Preview — Added Probability Context */}
      <div
        style={{
          background: '#FFFFFF',
          border: '1px solid #E5E7EB',
      ...
      >
        ...
        {/* V3: Micro-context line showing probability */}
        <p style={{ fontSize: 13, color: '#2563EB', fontWeight: 500, margin: '0 0 12px 0' }}>
          Interview probability: {screeningProbability}
        </p>
      ...
      {/* V3 OPTIMIZATION 4️⃣ Strategic Follow-up Timing — Time-Aware CTA Logic */}
      <div
        style={{
          background: followUpWindowOpen ? '#F0FDF4' : '#F0F9FF',
          border: `2px solid ${followUpWindowOpen ? '#86EFAC' : '#BFDBFE'}`,
          borderRadius: 12,
          padding: 20,
        }}
      >
        <h4
          style={{
            fontSize: 14,
            fontWeight: 600,
            color: followUpWindowOpen ? '#166534' : '#0369A1',
            margin: '0 0 8px 0',
          }}
        >
          Follow-up window
        ...
        <p
          style={{
            fontSize: 15,
            fontWeight: 500,
            color: followUpWindowOpen ? '#15803D' : '#1E40AF',
            margin: '0 0 4px 0',
          }}
        >
          {followUpWindowOpen ? 'Ready to send' : `Opens in ${daysUntilFollowUp} days`}
        </p>
        <p style={{ fontSize: 13, color: followUpWindowOpen ? '#166534' : '#0369A1', margin: 0 }}>
